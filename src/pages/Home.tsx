...
export default function Home() {
  ...
  return (
    <div className="mx-auto max-w-md pb-8">
      {/* Header */}
      <div className="flex items-center justify-between px-5 pb-1 pt-[max(1.25rem,env(safe-area-inset-top))]">
                ...
                return (
                  <div key={project.id} className="rounded-xl border border-border bg-surface p-4">
                    ...
                    <button
                      ...
                      className="w-full rounded-lg border border-accent/40 py-2.5 text-sm font-medium text-accent hover:bg-accent/10"
                    >
                      Open Project
                    </button>
                  </div>
              ...
              {visibleActivity.map((item) => {
                ...
                return (
                  <button
                    ...
                    className="flex items-center gap-3 rounded-xl border border-border bg-surface p-3.5 text-left hover:border-accent/50"
                  >
